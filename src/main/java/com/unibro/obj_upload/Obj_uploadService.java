...
@ManagedBean
@ViewScoped
public class Obj_uploadService {

    private List<Obj_upload> objects;
    private Obj_upload selectedObject;
    private Obj_upload newObject;
     ...
     * @return the objects
     */
    public List<Obj_upload> getObjects() {
        return objects;
    }
     ...
     */
    public void setObjects(List<Obj_upload> objects) {
