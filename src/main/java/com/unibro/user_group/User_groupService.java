...
public class User_groupService {
    ...
    private List<User_group> objects;
    private User_group selectedObject;
    private User_group newObject;
     ...
     * @return the objects
     */
    public List<User_group> getObjects() {
        return objects;
    }
     ...
     */
    public void setObjects(List<User_group> objects) {
