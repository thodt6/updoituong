...
public class AppclientService {
    ...
    private List<Appclient> objects;
    private Appclient selectedObject;
    private Appclient newObject;
     ...
     * @return the objects
     */
    public List<Appclient> getObjects() {
        return objects;
    }
     ...
     */
    public void setObjects(List<Appclient> objects) {
