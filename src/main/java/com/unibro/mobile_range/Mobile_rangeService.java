...
@ManagedBean
@ViewScoped
public class Mobile_rangeService {

    private List<Mobile_range> objects;
    private Mobile_range selectedObject;
    private Mobile_range newObject;
     ...
     * @return the objects
     */
    public List<Mobile_range> getObjects() {
        return objects;
    }
     ...
     */
    public void setObjects(List<Mobile_range> objects) {
